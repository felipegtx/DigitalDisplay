...
namespace DigitalDisplay.Parsers
{
    public class DataParserResult
    {
        public const string DATA_DICTIONARY_FILE_NAME = "map.DigitalDisplay";
        public const string INVALID_LINE_MESSAGE = @"/!\\invalid format/!\";
